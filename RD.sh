...
echo $yellow
figlet -f future "aRAT Cyber ROS team"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"aRAT"$cyan" ROS team "$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"aRAT"$cyan" ROS team "$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"aRAT"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"aRAT"$cyan" ROS team "$white                               
read -p " ╰─$ " script
echo
echo
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : aRAT Cyber V			"
echo $purple"Gthub   : https://github.com/aratcyberV    "
echo $blue"youtube :https://www.youtube.com/channel/UCt4tz1sWIcBtBfrVN5UU2iw"
echo
echo $yellow"                 THANKS TO :               "
echo
echo $cyan"[+] mr.meh && mr.pussy"
echo $cyan"[+] awwchik && MacHibb"
echo $cyan"[+] mr.alone && mr.LionAS"
echo $cyan"[+] mr.Yaoming && mr.fahri"
echo $red"##########################$green" WELCOME "$red###########################"
